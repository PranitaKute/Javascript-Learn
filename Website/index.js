...
within other callbacks to the degree where the code is diffcult to read. 
Old patteren to handle asynchronous functions. 
...
interacting with the APIs to retrieve and send data asynchronously 
over the web. 
fetch(url, {options})   */
